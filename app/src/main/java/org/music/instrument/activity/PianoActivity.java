...
/*
 * Piano
 * Virtual instrument based on Hexiano (https://gitorious.org/hexiano)
 ...
 * Created by GAGAN.
 */
public class PianoActivity extends Activity implements OnSharedPreferenceChangeListener {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        // floatingActionButton.setColorNormal(R.color.primary);
        ...
        floatingActionButton.setColorPressed(getResources().getColor(R.color.primary_dark));
        ...
        b1.setOnClickListener(new View.OnClickListener() {
            public void onClick(View view) {
                stopPlaying();
                mp = MediaPlayer.create(PianoActivity.this, R.raw.drumbeat1);
                mp.start();
            }
        });
        b2.setOnClickListener(new View.OnClickListener() {
            public void onClick(View view) {
                stopPlaying();
                mp = MediaPlayer.create(PianoActivity.this, R.raw.drumbeat2);
                mp.start();
            }
        });
        b3.setOnClickListener(new View.OnClickListener() {
            public void onClick(View view) {
                stopPlaying();
                mp = MediaPlayer.create(PianoActivity.this, R.raw.dubstep1);
                mp.start();
            }
        });
        ...
        sublayout.addView(b1);
        sublayout.addView(b2);
        sublayout.addView(b3);
    ...
    public boolean onOptionsItemSelected(MenuItem item) {
        ...
        startActivity(new Intent(PianoActivity.this, SettingsActivity.class));
        return true;
    }
        ...
        if (key.equals("pref_octaves")) {
            ...
            if (!(octaves.equals(sharedPreferences.getString(key,
                ...
                for (int i = 0; i < pianoView.numberOfNotes; i++) {
                    ...
                    if (octaves.equals(PianoActivity.this.getString(R.string.pref_octaves_45_value))) {
                        resourceId = this.getApplicationContext().getResources().
                                getIdentifier("note"
                    ...
                    if (octaves.equals(PianoActivity.this.getString(R.string.pref_octaves_35_value))) {
                        resourceId = this.getApplicationContext().getResources().
                                getIdentifier("note"
...
//				!(ViewConfiguration.get(this.getApplicationContext()).hasPermanentMenuKey())
    ...
    // Custom view.
    class PianoLayout extends View {
        ...
        // sound identifications array, to associate a instrument key with its sound
        ...
        public PianoLayout(Context context) {
            ...
            for (int i = 0; i < numberOfNotes; i++) {
                ...
                if (octaves.equals(PianoActivity.this.getString(R.string.pref_octaves_34_value))) {
        ...
        public boolean onTouchEvent(MotionEvent event) {
            ...
            if (damper.equals(
                    PianoActivity.this.getString(R.string.pref_damper_dampen_value))) {
        ...
        protected void onSizeChanged(int w, int h, int oldw, int oldh) {
            ...
            Toast.makeText(PianoActivity.this.getApplicationContext(), "Vol" + "\u2191" + "+" + "Vol" + "\u2193" + " " + "\u2192" + " menu",
